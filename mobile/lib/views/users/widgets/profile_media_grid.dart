              ...
              SliverPadding(
                ...
                sliver: SliverGrid(
                  ...
                  delegate: SliverChildBuilderDelegate(
                    (context, index) =>
                        _MediaTile(type: type, index: index),
...
class _MediaTile extends StatelessWidget {
  const _MediaTile({required this.type, required this.index});
  ...
  @override
  Widget build(BuildContext context) {
    final seed = '${type.name}-$index';
    final imageUrl = type == ProfileMediaType.reel
    ...
    return Stack(
      ...
      children: [
        ...
        if (type == ProfileMediaType.post && index % 4 == 0)
          const Positioned(
            top: 6,
            right: 6,
            child: Icon(Icons.filter_none_rounded, color: Colors.white, size: 16),
          ),
